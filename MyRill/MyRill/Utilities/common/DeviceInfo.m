...
+ (BMTime) getSystemPreciseTime
{
    ...
    currentTime.year  = [conponent year];
    currentTime.month = [conponent month];
    currentTime.day   = [conponent day];
    currentTime.hour  = [conponent hour];
    currentTime.minute= [conponent minute];
    currentTime.second= [conponent second];
