...
typedef enum E_PUSH_CATEGORY_TYPE
{
    ...
    e_Push_Category_Assignment = 5,  //任务
    e_Push_Category_Profession = 6,  //业务-系统消息
    e_Push_Category_Profession_Apply = 7, //业务下发
...
#define PUSH_CATEGORY_ENTERPRISE_ACCEPT @"enterprise_accpt"
